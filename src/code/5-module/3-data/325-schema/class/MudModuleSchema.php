...
class MudModuleSchema extends MudModuleData {
  ...
  function get_database( $name ) {
    ...
    if ( ! isset( $map[ $name ] ) ) {
      ...
      $map[ $name ] = new MudSchemaDatabase( $name );
  ...
  function get_migration() : MudSchemaMigration {
  ...
  function add_tab( $table_name ) : MudSchemaAddition_Table {

    return $this->get_migration()->add_tab( $table_name );
  ...
  function add_ref( $ref_name, $ref_table, $ref_col ) : MudSchemaAddition_ColumnReference {

    return $this->get_migration()->curr_tab()->add_ref( $ref_name, $ref_table, $ref_col );
