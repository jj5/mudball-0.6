...
define( 'MUD_CODEGEN_COUNTRY_CODE_ENUM_CLASS_FILE',    'country-code-enum-class.php' );
define( 'MUD_CODEGEN_COUNTRY_CODE_ENUM_PHP_FILE',    'country-code-enum-php.php' );
define( 'MUD_CODEGEN_COUNTRY_CODE_SPEC_FILE',  'country-code-spec.php' );
define( 'MUD_CODEGEN_COUNTRY_CODE_FILE',  'country-code.php' );
...
class MudCountryCodeImporter extends MudGenerator {
  ...
  protected function gen_enum( $country_data ) {
    ...
    $this->gen_enum_class( $country_data );

    $this->gen_enum_php( $country_data );

  }

  protected function gen_enum_class( $country_data ) {

    $file = $this->target . '/' . MUD_CODEGEN_COUNTRY_CODE_ENUM_CLASS_FILE;

    $this->report( "generating $file" );

    ob_start();

    $this->print_enum_class( $country_data );
  ...
  protected function gen_enum_php( $country_data ) {

    $file = $this->target . '/' . MUD_CODEGEN_COUNTRY_CODE_ENUM_PHP_FILE;

    $this->report( "generating $file" );

    ob_start();

    $this->print_enum_php( $country_data );
  ...
  protected function gen_schema( $country_data ) {
    ...
    $file = $this->target . '/' . MUD_CODEGEN_COUNTRY_CODE_SPEC_FILE;

    $this->report( "generating $file" );

    ob_start();

    $this->print_spec( $country_data );
  ...
  protected function gen_loader() {

    $file = $this->target . '/' . MUD_CODEGEN_COUNTRY_CODE_FILE;
...
<?php
  ...
  protected function print_enum_class( $country_data ) {
...
<?php
  ...
  protected function print_enum_php( $country_data ) {
...
<?php
  ...
  protected function print_spec( $country_data ) {
  ...
  return [
    [
      ...
      'numeric_code' => null,
      'numeric_value' => null,
      'is_using_full_name' => null,
      'name' => null,
      'name_ascii' => null,
      'full_name' => null,
      'full_name_ascii' => null,
      'short_name' => null,
      'short_name_ascii' => null,
      'item' => null,
      'item_ascii' => null,
      'item_html' => null,
      'qualifier' => null,
      'qualifier_ascii' => null,
      'naked_qualifier' => null,
      'naked_qualifier_ascii' => null,
      'natural_sort' => null,
    ],
    [
...
<?php
  ...
  protected function print_loader() {
